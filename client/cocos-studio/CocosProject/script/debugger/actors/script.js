...
ThreadActor.prototype = {
  ...
  onDetach: function TA_onDetach(aRequest) {
    this.disconnect();
    dumpn("ThreadActor.prototype.onDetach: returning 'detached' define");
    return {
      type: "detached"
    };
  },
   ...
   *        Hook to modify the define before it is sent. Feel free to return a
   *        promise.
   */
   ...
   *        The request define received over the RDP.
   * @returns A response define.
   */
   ...
   *
   * @param Object aRequest
   *        The resume request define received over the RDP.
   */
  ...
  _paused: function TA__paused(aFrame) {
    ...
    // Send off the paused define and spin an event loop.
      ...
      if (!handler) {
        return { from: this.actorID,
                 ...
                 message: ('Actor "' + actorID +
                           '" does not recognize the define type ' +
...
PauseScopedActor.prototype = {
  ...
  /**
   * Returns the wrongState response define for this actor.
   */
...
SourceActor.prototype = {
  ...
  /**
   * Handler for the "prettyPrint" define.
   */
  ...
  /**
   * Handler for the "disablePrettyPrint" define.
   */
  ...
  /**
   * Handler for the "blackbox" define.
   */
  ...
  /**
   * Handler for the "unblackbox" define.
   */
