 ...
 *     some reply define (say, a tab actor grip or the "listTabs" response
 ...
 *
 *     - _extraActors
 *        An object whose own property names are factory table (and define)
 ...
 *      "applicationType" property in the greeting define. By default, this
 *      is "browser".
 *
 * Live lists:
 *
...
RootActor.prototype = {
  ...
  /**
   * Return a 'hello' define as specified by the Remote Debugging Protocol.
   */
  sayHello: function() {
    return {
      from: this.actorID,
